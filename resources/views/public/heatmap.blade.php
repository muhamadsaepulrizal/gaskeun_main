...
<body class="antialiased min-h-screen flex flex-col relative">
    ...
    <script>
        ...
        function clearAllMarkers() {
            for (const id in pangkalanMarkers) {
                pangkalanMarkers[id].remove();
            }
            pangkalanMarkers = {};
        ...
        function updateClusters() {
            ...
            const addMarker = (id, el, lng, lat, popup) => {
                if (!pangkalanMarkers[id]) {
                    ...
                    newMarkers[id] = pangkalanMarkers[id];
                    delete pangkalanMarkers[id];
                }
            };
        ...
        function renderMarkers(filterKecamatan = '') {
            ...
            // 1. Setup Pangkalan Data for Bounds
            if (markersOn) {
