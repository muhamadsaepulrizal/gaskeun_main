    ...
    <div class="overflow-x-auto">
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('disperindag.nelayans.edit', $item->id) }}" class="btn-edit" ><i class="fa-solid fa-pen-to-square mr-1"></i> Edit</a>
                ...
                @empty
                <tr><td colspan="4" class="text-center py-12" >Belum ada data nelayan.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
