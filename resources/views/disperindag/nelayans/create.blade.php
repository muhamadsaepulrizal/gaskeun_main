    ...
    <form action="{{ route('disperindag.nelayans.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative group mt-1">
                ...
                <input type="text" name="jenis_kapal" required class="input-field pl-11 w-full focus:ring-2 focus:ring-brand/20 transition-all" placeholder="Contoh: Kapal Motor">
            </div>
        ...
        <div>
            ...
            <div class="relative group mt-1">
                <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 group-focus-within:text-brand transition-colors"><i class="fa-solid fa-pen"></i></span>
                <input type="text" name="alat_tangkap" required class="input-field pl-11 w-full focus:ring-2 focus:ring-brand/20 transition-all" placeholder="Contoh: Jaring">
            </div>
