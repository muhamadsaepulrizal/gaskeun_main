    ...
    <form action="{{ route('disperindag.kecamatans.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative group mt-1">
                ...
                <input type="text" name="nama_kecamatan" required class="input-field pl-11 w-full focus:ring-2 focus:ring-brand/20 transition-all" placeholder="Nama kecamatan">
            </div>
