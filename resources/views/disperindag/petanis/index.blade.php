        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td >{{ $item->luas_lahan_m2 }}</td>
                    <td >{{ $item->jenis_komoditas }}</td>
                    <td class="text-right">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('disperindag.petanis.edit', $item->id) }}" class="btn-edit" ><i class="fa-solid fa-pen-to-square mr-1"></i> Edit</a>
                ...
                @empty
                <tr><td colspan="4" class="text-center py-12" >Belum ada data petani.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
